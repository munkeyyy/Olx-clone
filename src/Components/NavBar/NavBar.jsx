...
const NavBar = () => {
  ...
  return (
    <div className="flex bg-[#EEF1F3] py-3 px-6 items-center gap-4">
      <div className="logo">
        <Logo />
      </div>
      <div className="bg-white border-black border-2 py-2 px-6 w-[17vw] rounded-sm">
      ...
      <div className="search">
        <form action="" onSubmit={handleSubmit}>
          <div className="flex items-center">
            <input
              type="text"
              className="w-[52vw] bg-white border-black border-2 py-2.5 rounded-none px-3"
